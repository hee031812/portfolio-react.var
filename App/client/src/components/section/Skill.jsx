    ...
    return (
        <div id="section05">
            <div className='sec05__desc'>
                These are the skills I used while studying.<br />
                I can use these skills well and I enjoy using them.<br />
            </div>
            <section id="skill">
                <div className="skill__inner">
                    ...
                    <div className="skill__desc">
                        <div>
                            ...
                            <h3>{"{ 자바스크립트 }"}</h3>
                            <dd>클로저, 프로미스, 콜백, 비동기 프로그래밍과 같은 고급 자바스크립트 개념을<br />
                                이해하고 효과적으로 사용할 수 있습니다.</dd>
                            <dd>자바스크립트 기반의 프론트엔드 라이브러리나 프레임워크(예: React, Vue.js, Angular 등)를<br />
                                숙련되게 사용할 수 있습니다. 이를 통해 동적이고 반응형 웹
                        ...
                        <dd>클로저, 프로미스, 콜백, 비동기 프로그래밍과 같은 고급 자바스크립트 개념을<br />
                            이해하고 효과적으로 사용할 수 있습니다.</dd>
                        <dd>자바스크립트 기반의 프론트엔드 라이브러리나 프레임워크(React, Vue.js, Angular 등)를<br />
                            숙련되게 사용할 수 있습니다. 이를 통해 동적이고 반응형 웹
                            애플리케이션을 구축할 수 있습니다.</dd>
                        ...
                        <h3>{"{ 비트 }"}</h3>
                        <dd>
                            Vite를 사용하여 환경을 구축하는 데 경험이 있습니다.<br />
                            Vite 구조를 알고있으며, 재사용 가능한 컴포넌트 설계를 할 수 있습니다.</dd>
                        <dd>다양한 프레임워크와 라이브러리와의 통합에 능숙합니다.<br />
                            또한 개발 속도와 효율성을 크게 향상시킬 수 있습니다.</dd>


                        <div className="num">04.</div>
                        <h3>{"{ 제이쿼리 }"}</h3>
                        <dd>
                            웹 개발에서 jQuery를 사용해 웹사이트에 동적인 요소와 효과를 추가하는 데 능숙합니다.<br />
                            DOM 조작과 이벤트 핸들링을 간편하게 해결하죠.</dd>
                        <dd>AJAX를 사용한 비동기 통신으로 사용자 경험을 향상시키는 것에도 숙련되어 있습니다.<br />
                            크로스 브라우저 호환성 문제도 잘 해결해요.</dd>
                        ...
                        <h3>{"{ 몽고디비 }"}</h3>
                        <dd>
                            NoSQL 데이터베이스인 MongoDB를 사용하여 데이터 관리에 능숙합니다.<br />
                            유연한 데이터 모델링과 빠른 쿼리 성능을 제공하죠.</dd>
                        ...
                        <h3>{"{ 넥스트 제이에스 }"}</h3>
                        <dd>
                            서버 사이드 렌더링과 정적 사이트 생성을 위해 Next.js를 사용합니다.<br />
                            SEO 최적화와 빠른 로딩 시간을 제공해요.</dd>
                        ...
                        <h3>{"{ 노드 제이에스 }"}</h3>
                        <dd>
                            Node.js를 사용하여 효율적이고 확장 가능한 서버 사이드 애플리케이션을 구축합니다.<br />
                            비동기 이벤트 주도 아키텍처를 활용해 높은 처리량을 달성하죠.</dd>
                        ...
                        <h3>{"{ 사스 }"}</h3>
                        <dd>
                            CSS 전처리기인 Sass를 사용하여 효율적이고 재사용 가능한 스타일시트를 작성합니다.<br />
                            더 깔끔하고 구조화된 CSS 코드를 작성하죠.</dd>
